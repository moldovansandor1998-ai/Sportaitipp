-- A model reference image animated by an owned source video's motion.
...
alter table public.generation_jobs add constraint generation_jobs_type_check check (type in (
  ...
  'video_from_image','video_to_video','video_character_swap','character_motion_video',
  'talking_video','character_swap','motion_control','lip_sync','tts','video_to_prompt',
  'captioning','frame_extract','dataset_generation','carousel_page','viral_scene','ppv_render'
));
