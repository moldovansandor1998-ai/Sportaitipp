...
const CHARACTER_EDIT_PROMPT = "Image 1 is the source photograph; the subsequent images show the approved character identity from different views. Use the clearest face view for identity, and other views to confirm natural hair and head shape. Replace the visible person's face AND hair with the same woman's face and hair in the character reference photos. Maintain natural skin pores, texture, shadows and photographic grain. Preserve image 1's body, anatomy, hands, pose, clothing, background, framing, camera angle and realistic lighting. If a phone is visible, it should be a space gray iPhone 14 Pro Max, with a realistic size and correct camera arrangement; never add a phone when none is visible. Remove any watermark or text overlay only when authorized to edit the source; do not replace it with other text. The final person must have no tattoos; remove any visible tattoos while preserving natural skin texture. Avoid beauty filters, plastic skin, enlarged eyes or lips, altered body proportions and illustration. Deliver a convincing unretouched photograph. Do not add new people or objects.";
